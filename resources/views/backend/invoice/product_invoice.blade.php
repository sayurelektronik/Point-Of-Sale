            ...
            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                    <div class="auth-logo">
            			...
            			<h3>Jumlah Total Rp. {{ Cart::total() }}</h3>
                    </div>
                </div>
                ...
                <form class="px-3" action="{{ url('/final-invoice') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="payment_status" id="example-select" class="form-select">
                    ...
                    <div class="mb-3">
                        <label for="username" class="form-label">Bayar Sekarang</label>
                        <input class="form-control" type="text" name="pay" placeholder="Bayar Sekarang">
                    </div>

                    <div class="mb-3">
                        <label for="username" class="form-label">Jumlah Jatuh Tempo</label>
                        <input class="form-control" type="text" name="due" placeholder="Jumlah Jatuh Tempo">
                    </div>
